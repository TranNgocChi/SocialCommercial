            ...
            <div class="logoBox">
                ...
                <c:if test="${role!=3 && role!=null}">
                 ...
                 <c:if test="${role==3}">
                  ...
                  <a href="Shipper" ><h5>Chức năng của shipper</h5></a>
                  </c:if>
                <c:if test="${role==3}">
                    <div class="content">
...
<script type="text/javascript">
        function submitForm() {
            ...
            form.setAttribute("action", "xemdonhang"); // Đường dẫn tới servlet xemdonhang

            // Thêm bất kỳ dữ liệu hoặc tham số nào bạn muốn gửi trong POST request
            var input = document.createElement("input");
            input.setAttribute("type", "hidden");
            input.setAttribute("name", "parameterName");
            input.setAttribute("value", "parameterValue"); // Thay thế bằng giá trị bạn muốn gửi
